...
socket.on('gameQuestions', function(data){
    ...
    document.getElementById('playersAnswered').innerHTML = "ผู้เล่นที่ตอบ 0 / " + data.playersInGame;
    updateTimer();
});

socket.on('updatePlayersAnswered', function(data){
   document.getElementById('playersAnswered').innerHTML = "ผู้เล่นที่ตอบ " + data.playersAnswered + " / " + data.playersInGame; 
});
...
socket.on('GameOver', function(data){
    ...
    document.getElementById('question').innerHTML = "เกมจบแล้ว";
